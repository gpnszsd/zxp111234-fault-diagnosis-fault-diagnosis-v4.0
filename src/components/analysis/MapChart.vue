...
<script>
import { getMapData } from "../../api/bigDataAnalysis";
...
export default {
  ...
  props: ["id", "chartTitle", "chartData", "type", "xAxis", "legend","faultlegend", "energylegend",  "lineShow", "endPos"],
  mounted() {
    this.start();
  },
  beforeDestroy() {},
  methods: {
    ...
    drawChart(config) {
      ...
      if (this.type == "map") {
        ...
        const data = [
          [
            ['1月', '预警', 17096869, "Australia", '燃烧室异常'],
            ['2月', '预警', 27662440, "Canada", '燃烧室异常'],
            ['1月', '报警', 1154605773, "China", '燃烧室异常'],
            ['3月', '报警', 10582082, "Cuba", '燃烧室异常'],
            ['1月', '报警', 4986705, "Finland", '燃烧室异常'],
            ['4月', '报警', 56943299, "France", '燃烧室异常'],
            ['5月', '报警', 78958237, "Germany", '燃烧室异常'],
            ['6月', '报警', 254830, "Iceland", '燃烧室异常'],
            ['7月', '预警', 870601776, "India", '燃烧室异常'],
            ['8月', '预警', 122249285, "Japan", '燃烧室异常'],
            ['8月', '预警', 20194354, "North Korea", '燃烧室异常'],
            ['6月', '预警', 42972254, "South Korea", '燃烧室异常'],
            ['1月', '预警', 3397534, "New Zealand", '燃烧室异常'],
            ['4月', '预警', 4240375, "Norway", '燃烧室异常'],
            ['5月', '预警', 38195258, "Poland", '燃烧室异常'],
            ['7月', '一级故障', 147568552, "Russia", '燃烧室异常'],
            ['6月', '预警', 53994605, "Turkey", '燃烧室异常'],
            ['9月', '预警', 57110117, "United Kingdom", '燃烧室异常'],
            ['9月', '预警', 252847810, "United States", '燃烧室异常'],
          ],
          [
            ['1月', '预警', 23968973, "Australia", '输水管异常'],
            ['2月', '预警', 35939927, "Canada", '输水管异常'],
            ['3月', '一级故障', 1376048943, "China", '输水管异常'],
            ['4月', '预警', 11389562, "Cuba", '输水管异常'],
            ['5月', '报警', 5503457, "Finland", '输水管异常'],
            ['6月', '预警', 64395345, "France", '输水管异常'],
            ['7月', '报警', 80688545, "Germany", '输水管异常'],
            ['8月', '预警', 329425, "Iceland", '输水管异常'],
            ['9月', '报警', 1311050527, "India", '输水管异常'],
            ['6月', '报警', 126573481, "Japan", '输水管异常'],
            ['3月', '预警', 25155317, "North Korea", '输水管异常'],
            ['4月', '报警', 50293439, "South Korea", '输水管异常'],
            ['5月', '预警', 4528526, "New Zealand", '输水管异常'],
            ['6月', '预警', 5210967, "Norway", '输水管异常'],
            ['2月', '一级故障', 38611794, "Poland", '输水管异常'],
            ['7月', '一级故障', 143456918, "Russia", '输水管异常'],
            ['4月', '二级事故', 78665830, "Turkey", '输水管异常'],
            ['3月', '预警', 64715810, "United Kingdom", '输水管异常'],
            ['8月', '二级事故', 321773631, "United States", '输水管异常'],
          ],
        ];
        this.option = {
          legend: {
      ...
      } else if (this.type == "energyTrendline") {
        this.option = {
          tooltip: {
            trigger: "axis",
          },
          ...
          dataZoom: [{
              type: 'slider',
              show: self.lineShow, //flase直接隐藏图形
              xAxisIndex: [0],
              start: 0,//滚动条的起始位置
              end: self.endPos //滚动条的截止位置（按比例分割你的柱状图x轴长度）
          }],
          yAxis: [{
            type: "value",
            name: '效率',
          ...
          series: [
            {
              symbolSize: 5,
              data: [
                [18.78,90],[49.26,95],[70.58,93.1],[75.67,89]
              ],
              type: 'scatter'
            }
          ]
      ...
      else if (this.type == "faultTrendline") {
        this.option = {
          tooltip: {
            trigger: "axis",
          },
        ...
        this.option = {
          ...
          legend: {
            data: ['SCR脱硝', '汽水系统', '烟风系统', '热煤系统', '燃料系统', '除尘系统'],
            top: 'center',
            orient: 'vertical',
            right: 0
          },
